...
import CapitalTrustTheme from './themes/capital-trust';
import DataPrecisionTheme from './themes/data-precision';
import ExecutivePortfolioTheme from './themes/executive-portfolio';
import MidnightProTheme from './themes/midnight-pro';
import ProsperityHubTheme from './themes/prosperity-hub';
import WealthReserveTheme from './themes/wealth-reserve';
...
interface ThemeOption {
  ...
  name: string;
  description: string;
  component: typeof MidnightProTheme;
}
...
export default function PreviewPage() {
    ...
    return (
      <div className="min-h-screen w-full flex items-center justify-center bg-slate-950">
        <div className="text-center">
          ...
          <p className="text-white text-sm font-medium">Loading themes...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="min-h-screen w-full flex items-center justify-center bg-slate-950">
        <div className="text-center max-w-md px-6">
          ...
          <p className="text-slate-400 mb-6">
            Please sign in to view the theme preview with your account data.
          </p>
          <a
            href="/sign-in"
    ...
    return (
      <div className="min-h-screen w-full flex items-center justify-center bg-slate-950">
        <div className="text-center max-w-md px-6">
          ...
          <p className="text-slate-400 mb-6">
            Create your first account to see the theme previews in action.
          </p>
          <button
            type="button"
  ...
  const SelectedThemeComponent =
    THEMES.find((t) => t.id === selectedTheme)?.component || MidnightProTheme;
