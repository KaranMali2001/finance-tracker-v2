...
-- Foreign Keys
ALTER TABLE "accounts" ADD FOREIGN KEY ("user_id") REFERENCES "users" ("clerk_id") ON DELETE CASCADE;
ALTER TABLE "accounts" ADD FOREIGN KEY ("bank_id") REFERENCES "banks" ("id");

ALTER TABLE "categories" ADD FOREIGN KEY ("user_id") REFERENCES "users" ("clerk_id") ON DELETE CASCADE;
...
ALTER TABLE "transactions" ADD FOREIGN KEY ("user_id") REFERENCES "users" ("clerk_id") ON DELETE CASCADE;
...
ALTER TABLE "transactions" ADD FOREIGN KEY ("sms_id") REFERENCES "sms_logs" ("id");
ALTER TABLE "transactions" ADD FOREIGN KEY ("deleted_by") REFERENCES "users" ("clerk_id");

ALTER TABLE "transaction_attachments" ADD FOREIGN KEY ("transaction_id") REFERENCES "transactions" ("id") ON DELETE CASCADE;
ALTER TABLE "transaction_attachments" ADD FOREIGN KEY ("uploaded_by") REFERENCES "users" ("clerk_id");

ALTER TABLE "sms_logs" ADD FOREIGN KEY ("user_id") REFERENCES "users" ("clerk_id") ON DELETE CASCADE;

ALTER TABLE "monthly_expense_allocation" ADD FOREIGN KEY ("user_id") REFERENCES "users" ("clerk_id") ON DELETE CASCADE;
ALTER TABLE "monthly_expense_allocation" ADD FOREIGN KEY ("category_id") REFERENCES "categories" ("id");

ALTER TABLE "monthly_budgets" ADD FOREIGN KEY ("user_id") REFERENCES "users" ("clerk_id") ON DELETE CASCADE;
...
ALTER TABLE "recurring_transactions" ADD FOREIGN KEY ("user_id") REFERENCES "users" ("clerk_id") ON DELETE CASCADE;
...
ALTER TABLE "spending_limits" ADD FOREIGN KEY ("user_id") REFERENCES "users" ("clerk_id") ON DELETE CASCADE;
ALTER TABLE "spending_limits" ADD FOREIGN KEY ("category_id") REFERENCES "categories" ("id");

ALTER TABLE "goals" ADD FOREIGN KEY ("user_id") REFERENCES "users" ("clerk_id") ON DELETE CASCADE;
...
ALTER TABLE "bank_statement_uploads" ADD FOREIGN KEY ("user_id") REFERENCES "users" ("clerk_id") ON DELETE CASCADE;
...
ALTER TABLE "user_notifications" ADD FOREIGN KEY ("user_id") REFERENCES "users" ("clerk_id") ON DELETE CASCADE;

ALTER TABLE "notification_preferences" ADD FOREIGN KEY ("user_id") REFERENCES "users" ("clerk_id") ON DELETE CASCADE;

ALTER TABLE "activity_logs" ADD FOREIGN KEY ("user_id") REFERENCES "users" ("clerk_id") ON DELETE SET NULL;

ALTER TABLE "jobs" ADD FOREIGN KEY ("user_id") REFERENCES "users" ("clerk_id") ON DELETE CASCADE;
