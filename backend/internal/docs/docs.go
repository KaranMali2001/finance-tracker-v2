...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/investment/goal": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "number",
                        "description": "Target amount less than",
                        "name": "target_amount_less_than",
                        "in": "query"
                    },
                    {
                        "type": "number",
                        "description": "Target amount greater than",
                        "name": "target_amount_greater_than",
                        "in": "query"
                    },
                    {
                        "type": "integer",
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/internal_domain_investment.Goal"
                            }
                        }
                    },
                    "400": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_domain_investment.CreateGoalReq"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_domain_investment.UpdateGoals"
                        }
                    }
                ],
                "responses": {
        ...
        "/reconciliation/results/status": {
            "patch": {
                ...
                "parameters": [
                    {
                        "description": "Result IDs and user action",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_domain_reconciliation.BulkUpdateResultStatusReq"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_domain_reconciliation.BulkUpdateResultStatusRes"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/reconciliation/upload": {
            "post": {
                ...
                "parameters": [
                    {
                        "type": "file",
                        "description": "Bank statement Excel file (.xls, .xlsx)",
                        "name": "statement",
                        "in": "formData",
                        "required": true
                    },
        ...
        "/reconciliation/uploads/{upload_id}/detail": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_domain_reconciliation.UploadFullDetailPaginated"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/reconciliation/uploads/{upload_id}/results": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_domain_reconciliation.PaginatedReconciliationResults"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/sms": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/internal_domain_sms.SmsLogs"
                            }
                        }
                    },
                    "401": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "SMS creation request",
                        "name": "sms",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_domain_sms.CreateSmsReq"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "internal_domain_investment.Goal": {
            "type": "object",
            "properties": {
                "achieved_at": {
                    "type": "string"
        ...
        "internal_domain_investment.UpdateGoals": {
            "type": "object",
            "required": [
                "id"
            ],
        ...
        "internal_domain_reconciliation.BulkUpdateResultStatusReq": {
            "type": "object",
            "required": [
                "result_ids",
                "upload_id",
        ...
        "internal_domain_reconciliation.BulkUpdateResultStatusRes": {
            "type": "object",
            "properties": {
                "updated": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/internal_domain_reconciliation.UpdateResultStatusRes"
                    }
                }
            }
        },
        "internal_domain_reconciliation.MatchSignals": {
            "type": "object",
            "properties": {
                "amount_diff": {
                    "type": "number"
        ...
        "internal_domain_reconciliation.PaginatedReconciliationResults": {
            "type": "object",
            "properties": {
                "page": {
                    "type": "integer"
                ...
                "results": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/internal_domain_reconciliation.ReconciliationResultRow"
                    }
                },
                "total": {
                    "type": "integer"
        ...
        "internal_domain_reconciliation.ParsedTxns": {
            ...
            "properties": {
                ...
                "type": {
                    "$ref": "#/definitions/internal_domain_reconciliation.TxnType"
                },
                "updated_at": {
                    "type": "string"
                },
        ...
        "internal_domain_reconciliation.ReconciliationResultRow": {
            "type": "object",
            "properties": {
                "app_transaction_id": {
                    "type": "string"
                ...
                "match_signals": {
                    "$ref": "#/definitions/internal_domain_reconciliation.MatchSignals"
                },
                "match_status": {
                    "type": "string"
                },
                ...
                "stmt_date": {
                    "description": "Statement transaction side",
                    "type": "string"
                },
                "stmt_description": {
                    "type": "string"
                },
                "stmt_reference_number": {
                    "type": "string"
                },
                "stmt_row_number": {
                    "type": "integer"
        ...
        "internal_domain_reconciliation.StatementTransaction": {
            "type": "object",
            "properties": {
                "account_id": {
                    "type": "string"
        ...
        "internal_domain_reconciliation.TxnType": {
            "type": "string",
            "enum": [
                "CREDIT",
                "DEBIT"
        ...
        "internal_domain_reconciliation.UpdateResultStatusRes": {
            "type": "object",
            "properties": {
                "id": {
                    "type": "string"
        ...
        "internal_domain_reconciliation.UploadFullDetailPaginated": {
            "type": "object",
            "properties": {
                "account_id": {
                    "type": "string"
                ...
                "transactions": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/internal_domain_reconciliation.StatementTransaction"
                    }
                },
                "updated_at": {
                    "type": "string"
